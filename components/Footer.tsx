...
const Footer = () => {
    return (
        <footer className='w-full mb-[100px] md:mb-9 pb-10 ' id='contact'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <a href='mailto:lakshyadeep19@gmail.com'>
                    <MagicButton
            ...
            <div className='flex mt-16 md:flex-row flex-col justify-between items-center '>
                <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 | Lakshyadeep Gogoi</p>
